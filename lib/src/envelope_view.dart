...
class _SplashLottieViewState extends State<SplashLottieView>
  ...
  Future<void> _onAnimationFinished() async {
    ...
    if (widget.onFinished != null) {
      ...
      // Navegación por defecto (ajústala a tu flujo)
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => Invitation1(
                ...
                child: Center(
                  child: ConstrainedBox(
                    ...
                    child: Text(
                      ...
                      style: InvStyles.text.copyWith(color: AppColors.onSurfaceGold),
                      textAlign: TextAlign.center,
                    ),
                  ),
                ),
